...
for (let i = 0; i < arrayNumbers.length; i++){ 
     sumNum += arrayNumbers[i]
 }

 return sumNum / arrayNumbers.length
...
function howManyTimes(wordRepeat) {
  if (wordRepeat.length === 0){
  return 0
  }
